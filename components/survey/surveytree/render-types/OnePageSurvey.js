...
function OnePageSurvey(props) {
    ...
    return (
        ...
        options.map((option, i) => {
            ...
            } else if (option.typ === state.group.typ) {
                return <GroupOption option={option} optionTyp={state.group.typ} index={indexValue} key={i} />
...
export default memo(OnePageSurvey)