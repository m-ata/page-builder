            ...
            Insert({
                ...
                if (r1.status === 200) {
                    ViewList({
                        ...
                        if (r2.status === 200) {
                            pushToState('registerStepper', ['hcmItemVidCategory'], [r2.data.data[0]])
                            handleClose()
                            setCategoryName('')
                            setToState('registerStepper', ['videosTabIndex'], state.hcmItemVidCategory.length)
...
export default connect(mapStateToProps, mapDispatchToProps)(NewHcmVidCategory)
