...
import HcmItemVidPlayer from './HcmItemVidPlayer'
...
const HcmItemVidViewer = (props) => {
    ...
    const handleHcmItemVidDel = (itemGid) => {
        setIsDeleting(true)
        Delete({
            apiUrl: GENERAL_SETTINGS.OREST_URL,
    ...
    return (
        <React.Fragment>
            <Card className={classes.card}>
                <video onContextMenu={(e) => e.preventDefault()} className={classes.videoThumb}>
                ...
                <CardActions disableSpacing style={{ padding: 5 }}>
                    ...
                    <Tooltip title="Delete Category Item">
                        <IconButton
                            ...
                            size="small"
                            disabled={isDeleting}
                            onClick={() => handleHcmItemVidDel(itemGid)}
                        >
                            <DeleteIcon fontSize={'small'} />
                        </IconButton>
                    </Tooltip>
                    <HcmItemVidPlayer videoUrl={videoUrl} />
                ...
                <DialogContent>
                    <Grid container spacing={3} direction="row" justify="center" alignItems="center">
                        ...
                        <Grid item xs={12} sm={4}>
                            <Button fullWidth variant="contained" color="primary" onClick={() => handleVidTagIns()}>
                                {t('str_addTag')}
                            </Button>
                        </Grid>
                    </Grid>
                                ...
                                {itemTagList && itemTagList.length > 0 ? (
                                    itemTagList.map((tagItem, tagIndex) => (
                                        <Chip
                                            ...
                                            onDelete={() => handleVidTagDel(tagItem.gid)}
...
export default connect(mapStateToProps, mapDispatchToProps)(HcmItemVidViewer)
