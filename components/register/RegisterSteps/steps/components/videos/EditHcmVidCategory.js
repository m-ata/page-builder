...
const EditHcmVidCategory = (props) => {
    ...
    const [categoryName, setCategoryName] = useState(state.hcmItemVidCategory[groupIndex].description)
    ...
    const handleSave = () => {
        if (!categoryName) {
            ...
            Patch({
                ...
                token: token,
                gid: state.hcmItemVidCategory[groupIndex].gid,
                data: {
                    code: categoryName,
                ...
                if (r1.status === 200) {
                    ViewList({
                        ...
                        if (r2.status === 200) {
                            setToState(
                                'registerStepper',
                                ['hcmItemVidCategory', String(groupIndex), 'code'],
                                r2.data.data[0].code
                            )
                            setToState(
                                'registerStepper',
                                ['hcmItemVidCategory', String(groupIndex), 'description'],
...
export default connect(mapStateToProps, mapDispatchToProps)(EditHcmVidCategory)
