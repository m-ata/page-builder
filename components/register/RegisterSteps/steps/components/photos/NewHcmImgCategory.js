            ...
            Insert({
                ...
                if (r1.status === 200) {
                    ViewList({
                        ...
                        if (r2.status === 200) {
                            pushToState('registerStepper', ['hcmItemImgCategory'], [r2.data.data[0]])
                            handleClose()
                            setCategoryName('')
                            setToState('registerStepper', ['photosTabIndex'], state.hcmItemImgCategory.length)
...
export default connect(mapStateToProps, mapDispatchToProps)(NewHcmImgCategory)
