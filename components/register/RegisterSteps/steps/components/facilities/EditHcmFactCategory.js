...
const EditHcmFactCategory = (props) => {
    ...
    const [categoryName, setCategoryName] = useState(state.hcmFacilities[groupIndex].description)
    ...
    const handleSave = () => {
        if (!categoryName) {
            ...
            Patch({
                ...
                token: token,
                gid: state.hcmFacilities[groupIndex].gid,
                data: {
                    code: categoryName,
                ...
                if (r1.status === 200) {
                    ViewList({
                        ...
                        if (r2.status === 200) {
                            setToState(
                                'registerStepper',
                                ['hcmFacilities', String(groupIndex), 'code'],
                                r2.data.data[0].code
                            )
                            setToState(
                                'registerStepper',
                                ['hcmFacilities', String(groupIndex), 'description'],
...
export default connect(mapStateToProps, mapDispatchToProps)(EditHcmFactCategory)
